...
/**
 * @author liumingxin
 * @create 2018 20 17:11
 * @desc
 **/
public class CrfExcludeUqlClass extends UqlClass {
    public CrfExcludeUqlClass(String from){
        super(from);
    }

    public CrfExcludeUqlClass(String from,String crfId){
        super(from,crfId);
    }
