...
public class LogUtilsTest {
    ...
    @Autowired
    SearchByuqlService searchByuqlService;
...
//        long a = redisMapDataService.delete("dfsdfsd");
        String a = "4854AB9CCDF6497093E378D892BDC373";
        System.out.println(UqlConfig.CORT_INDEX_REDIS_KEY.concat(a));
        System.out.println(redisMapDataService.exists(UqlConfig.CORT_INDEX_REDIS_KEY.concat(a)));
        System.out.println(redisMapDataService.exists(UqlConfig.CORT_INDEX_REDIS_KEY.concat(a)));
        System.out.println(redisMapDataService.exists(UqlConfig.CORT_INDEX_REDIS_KEY.concat(a)));
        System.out.println(redisMapDataService.exists(UqlConfig.CORT_INDEX_REDIS_KEY.concat(a)));
        System.out.println(redisMapDataService.exists(UqlConfig.CORT_INDEX_REDIS_KEY.concat(a)));
